...
import { removeLabel, updateLabel } from "../../../store/portsSlice";

/**
 * Form Validation Schema
 */
const schema = yup.object().shape({
  number: yup.string().required("You must enter a label number"),
});
...
function NewLabelForm(props) {
  ...
  useEffect(() => {
    handleOnChange(port, form);
  }, [handleOnChange, port, form]);

  function handleOnRemove() {
    dispatch(removeLabel(port.id));
  }
